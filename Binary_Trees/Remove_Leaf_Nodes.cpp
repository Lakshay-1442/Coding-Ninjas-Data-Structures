...
BinaryTreeNode<int>* removeLeafNodes(BinaryTreeNode<int> *root) 
{
    ...
    BinaryTreeNode<int>* smallAns1 = removeLeafNodes(root -> left);
    BinaryTreeNode<int>* smallAns2 = removeLeafNodes(root -> right);
    
    if (root -> left != NULL || root -> right != NULL)
    {
        BinaryTreeNode<int>* new_root = new BinaryTreeNode<int>(root -> data);

        new_root -> left = smallAns1;
        new_root -> right = smallAns2;
